...
const documents: DocItem[] = [
  {
    ...
    href: "/docs/cv.pdf",
    download: "CV Alt_Bac+3_Anthony Faria Dos Santos.pdf",
    color: "#6ee7b7",
  },
  {
    icon: Award,
    title: "Lettre de recommandation",
    description: "Recommandation professionnelle",
    href: "/docs/recommandation.pdf",
    download: "Lettre recommandation Faria Dos Santos Anthony.pdf",
    color: "#fbbf24",
  },
  {
    icon: GithubIcon,
    title: "GitHub",
    description: "Profil et projets open source",
  ...
  //{
  //  icon: GraduationCap,
  //  title: "Bachelor 3 DSNS",
  //  description: "Programme de formation ESIEE-IT",
  //  href: "https://www.esiee-it.fr/fr/bac-3-developpeur-de-solutions-numeriques-securisees-titre-rncp-niveau-6",
  //  external: true,
  //  color: "#6ee7b7",
  //},
  //{
  //  icon: GraduationCap,
  //  title: "Master E3IN",
  //  description: "Cursus Expert Cybersecurite ESIEE-IT",
  //  href: "https://www.esiee-it.fr/fr/Bac5-cybersecurite",
  //  external: true,
  //  color: "#c084fc",
  //},
  {
    ...
    description: "Notes et supports de revision",
    href: "https://github.com/Anthony-Faria-dos-santos/CCNA-exam-prep-support-material",
    external: true,
    color: "#818cf8",
  },
  {
    icon: BookOpen,
    title: "RNCP Titre Pro DWWM",
    description: "Fiche France Competences nv5",
  ...
  //{
  //  icon: BookOpen,
  //  title: "RNCP Bachelor 3 DSNS",
  //  description: "Fiche France Competences nv6",
  //  href: "https://www.francecompetences.fr/recherche/rncp/37778/",
  //  external: true,
  //  color: "#6ee7b7",
  //},
  //{
  //  icon: BookOpen,
  //  title: "RNCP Master E3IN",
  //  description: "Fiche France Competences nv7",
  //  href: "https://www.francecompetences.fr/recherche/rncp/37744/",
  //  external: true,
  //  color: "#c084fc",
  //},
];
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "conic-gradient(from 0deg, #6ee7b7, #818cf8, #fbbf24, #c084fc, #6ee7b7)",
        }}
        animate={{ rotate: 360 }}
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="text-sm font-medium text-foreground group-hover:text-[#6ee7b7] transition-colors truncate">
          {doc.title}
        </p>
        <p className="text-xs text-[#8b8b99] truncate">{doc.description}</p>
      </div>
      {doc.external && (
        <ExternalLink className="w-3.5 h-3.5 text-[#8b8b99] shrink-0 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
      )}
      {isDownload && (
        <Download className="w-3.5 h-3.5 text-[#8b8b99] shrink-0 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
      )}
    </motion.div>
  );
}
